...
export default function Login({ visible, onClose }) {
  ...
  return (
    <div>
      ...
      >
        <div className="w-80  fixed  md:w-[45rem]   mt-5 bg-[url('https://images.pexels.com/photos/633409/pexels-photo-633409.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] bg-contain  ">
          ...
          <div className=" md:w-auto   block items-center   overflow-hidden  h-[800px]  bg-[url('https://cybrom.com/wp-content/uploads/2023/04/Logo-for-website-1.png')]   bg-no-repeat     bg-contain ">
