...
export default function Lorem() {
  ...
  return (
    <>
      {/* first section  */}
      <div className="relative grid grid-cols-1 md:grid-cols-3 bg-slate-300  rounded-tr-3xl">
        <div className="">
          ...
          <div className=" md:text-start text-center md:w-[450px] w-full mt-10 ml-0  md:ml-24 ">
            <h1 className="text-4xl font-bold text-[#040239]">
              <Typewriter
              options={{
                    autoStart:true,
                    delay:50,
                    loop:true,
                    strings:['Learn Job ready skills from online courses with certificates']
              }}
              />
            ...
            <button className="relative btn4 mt-12 px-10 py-5 border border-black uppercase text-blue-500 font-semibold tracking-wider leading-none overflow-hidden" type="button">
      ...
      <span className="text-#de5e18">
        ...
        <div className=" col-span-2 flex justify-end pb-10">
          ...
          <img 
            src="https://www.bloombraineducation.com/assets/images/coding-graphic-png.png"
            className="mt-10  "
            alt=""
          />
     ...
     <TeacherCard/>
      ...
      {/* _______________________________________________Educator div End here_____________________________________ */}
    <p className="text-4xl font-bold my-20  text-center ">Fuel your career with our 500+ hiring partners</p>
...
<h1 className="md:text-4xl text-2xl  p-0 md:p-5  ">advice given to students to help them make educational or personal decisions</h1>
<img src="https://almablog-media.s3.ap-south-1.amazonaws.com/Group_1000002116_0863fca8fa.png" alt=""  className="skew-y-6 md:mt-2 mt-5"/>
        </div>
        <div className="">
          <div className="md:mt-64 mt-10 ">

          <p className="text-2xl text-center md:text-start text-#de5e18"> Guidelines for acts and content that are prohibited</p>
          ...
          {/* <button className="bg-[linear-gradient(#e66465, #9198e5);]  hover:bg-orange-300 p-5 text-2xl mt-8 rounded-3xl animate-bounce  text-gray-900 font-bold ml-8">
            ...
            <button className=" relative btn4   mt-12 px-10 py-5 border border-black uppercase text-#de5e18 font-semibold tracking-wider leading-none overflow-hidden" type="button">
...
<img src="  https://cybrom.com/wp-content/uploads/2023/03/roadmap-min-1-1536x864.jpg" alt=""  className="w-[90%] md:w-[60%]"/>
  </div>
<div>
...
<div className="grid grid-cols-1 md:grid-cols-3  text-center mt-10  ">
    ...
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRioQJUMTBxwm1mrtxo7zMhRIw_Bj9STxntig&usqp=CAU" width="80%" className="m-auto"/>
		<div className="bg-white    p-8 rounded-lg ">
		<h1 className="text-2xl font-bold mt-4 md:mt-10 ">mision</h1>
		<p>We at Whiltor are committed to bring the best in our society and to remove hesitation from our youth to start a new venture of thier own due lack of knowledge of a technology or resources. We are continously working to .</p>
    </div>
	</div>
	</div>
	<div className="  m-auto  my-20  ">
    <div className="w-80 shadow-[0_35px_60px_-15px_rgba(0,0,0,0.8)] p-2">
    <img src="https://img.freepik.com/free-vector/business-vision-concept-illustration_114360-7130.jpg?w=360" width="70%" className="m-auto"/>
	...
	<div className="  m-auto ">
    <div className="w-80 shadow-[0_35px_60px_-15px_rgba(0,0,0,0.8)] p-2 mr-32">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIJyaq3rQHEesFi5VG28aM4_SFk7L_6p53WA&usqp=CAU" width="70%" className="m-auto"/>
		<div className="bg-white    p-8 pt-0 rounded-lg ">
